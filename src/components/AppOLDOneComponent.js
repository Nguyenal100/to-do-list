...
class App extends Component {
  ...
  render(){
    ...
    const listItems = this.state.toDos.map(toDo => <li key={toDo.id}> {toDo.name} <button onClick={e => this.deleteToDo(toDo)} > Delete </button> <button onClick ={e => this.editToDo(toDo)}> Edit </button> </li>)
